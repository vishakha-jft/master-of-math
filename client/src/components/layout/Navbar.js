      ...
      <div>
        <nav className="nav-wrapper navlink blue fixed" style={{backgroundColor: "rgba(0,0,0,0)"}}>
          <div className="container">
            <Link to='/' className="brand-logo">MastersOfMath</Link>
            <Link to='' className="sidenav-trigger navlink" data-target="mobile-links"><i className="material-icons">menu</i></Link>
