...
function Footer(){
    return(
        ...
        <div className="container">
          <div className="row">
            <div className="col l6 s12">
              <h5 className="white-text" id="brand">MastersOfMath</h5>
        ...
        <div className="footer-copyright">
          <div className="container">
            © Copyright MastersOfMath
            <h6 className="white-text" style={{textAlign: "right"}}>Our Creators</h6>
            <a className="grey-text text-lighten-4 right cr" href="https://github.com/YesVishakha">|| Vishakha ||</a>
          </div>
        </div>
      </footer>
